using ATemplate.Abstractions.CQRS;
using ATemplate.Abstractions.ResultResponse;
using ATemplate.Database;
using ATemplate.Entities;

namespace ATemplate.Features.Products.UpdateProduct;
